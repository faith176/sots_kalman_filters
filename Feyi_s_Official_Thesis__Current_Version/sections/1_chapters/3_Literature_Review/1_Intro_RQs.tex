...
\begin{itemize}
    \item \rquestion{RQ1. Why integrate Digital Twins into Systems of Systems?} This question seeks to uncover the motivations and intents behind forming SoTS, the domains where they are applied, and the key challenges that arise when multiple DTs are organized as a coordinated system.
    \item \rquestion{RQ2. How are Digital Twins integrated into Systems of Systems?} This question examines the architectural principles used to organize DTs within an SoS. We analyze the nature of constituent units (physical, digital, or hybrid) and classify the resulting SoS structures.
\end{itemize}
...
\begin{itemize}
    ...
    \item \rquestion{RQ4. What are the technical characteristics of Systems of Systems in SoTS?} This question examines SoS-level properties in SoTS, such as SoS classifications, coordination mechanisms, and the types of emergent behaviour addressed.
\end{itemize}
...
\vspace{0.5em}
\noindent \textbf{\large Reliability, Maturity, and Implementation}
\vspace{-1em}
\begin{itemize}
