...
The systematic literature review in \chref{ch:literature-review} indicates that existing research provides limited guidance on how reliability in SoTS should be characterized or assessed. In SoS contexts, reliability is commonly understood as the ability to maintain mission fulfilment despite disturbances \cite{ferreira2023towards}. To reason about such disturbances in SoTS, this chapter characterizes them along two interacting dimensions: belonging and operational health. These dimensions are represented using the Statecharts modelling formalism \cite{harel1987statecharts}, enabling systematic reasoning about how disturbances arise and affect reliability in SoTS.
