...
% 2–3 paragraphs: intuition + role in SoTS
% + minimal equations (state + observation model)
% + one sentence: "full formulation provided in Appendix X"
...
% \subsection{Uncertainty-Driven Lifecycle Control}\label{sec:eval-uncertainty-control}
...
% \subsubsection{Threshold Sensitivity Analysis}\label{sec:eval-threshold-sensitivity}
